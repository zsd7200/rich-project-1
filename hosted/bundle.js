...
var init = function init() {
    ...
    getButton.addEventListener('click', function () {
        ...
        if (input.value === "mimikyu") input.value = "mimikyu-disguised";
        if (input.value === "minior-meteor") input.value = "minior-red-meteor";
        if (input.value === "minior-core") input.value = "minior-red";
        if (input.value === "lycanroc") input.value = "lycanroc-midday";
        if (input.value === "pumpkaboo") input.value = "pumpkaboo-average";
        if (input.value === "gourgeist") input.value = "gourgeist-average";
