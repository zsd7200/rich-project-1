            ...
            if (newString.includes("alola")) {
                for (var _i = 0; _i < newString.length; _i++) {
                    if (newString[_i] === "-") {
                        ...
                        newString = _afterDash + "n " + _beforeDash;
                    }
                }
            }

            // loop through to see if there's a dash
            for (var _i2 = 0; _i2 < newString.length; _i2++) {
                if (newString[_i2] === "-") {
                    // if a dash is found, make two new strings, then add them together
                    var _beforeDash2 = newString.slice(0, _i2);
                    var _afterDash2 = newString.charAt(_i2 + 1).toUpperCase() + newString.slice(_i2 + 2);
                    newString = _beforeDash2 + " " + _afterDash2;
                }
            }break;
    }
...
var init = function init() {
    ...
    getButton.addEventListener('click', function () {
        ...
        if (input.value === "zygarde-10%") input.value = "zygarde-10";
